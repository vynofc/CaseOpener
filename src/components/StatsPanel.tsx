  ...
  return (
    <section id="stats" className="panel p-5 scroll-mt-20">
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          onClick={() => {
            if (window.confirm("Really reset everything? Your inventory and statistics will be lost.")) resetAll();
          }}
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
        ...
        <Stat label="Spent" value={formatMoney(stats.spent)} className="text-red-400" />
        <Stat label="Earned" value={formatMoney(stats.earned)} className="text-emerald-400" />
        <Stat
          label="Net"
      ...
      {stats.bestDrop && (
        <div className="mt-4 rounded-sm bg-cs-950/70 border border-white/10 p-3 flex items-center gap-3">
          ...
          <div className="min-w-0">
            <div className="text-[10px] uppercase tracking-wider text-zinc-500">Best drop</div>
